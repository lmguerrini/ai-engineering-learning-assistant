...
_LEARN_PATH_DEEP_STUDY_ENGINEERING_RULES = (
    "SENIOR ENGINEERING DEPTH RULES:\n"
    "- Write like a senior AI engineering mentor reviewing a production system, not generic courseware.\n"
    "- Prefer dense operational reasoning over repeated definitions; explain engineering tradeoffs, architecture decisions, and when to use / when not to use the approach.\n"
...
def _build_deep_study_markdown_prompt(state: LearningState) -> str:
    ...
    return (
        ...
        f"explanation are unacceptable. The goal is practical senior-level "
        f"engineering judgment, not generic LLM courseware.\n\n"
...
def _build_progressive_learn_path_section_prompt(
    ...
    return (
        ...
        f"as a senior AI engineering mentor.\n"
        ...
        f"- Make the section dense, practical, and production-aware rather than encyclopedia-like.\n"
